...
function crearFilaGasto(n="", v="") {
    ...
    f.cells[0].innerHTML = `<input value="${n}" placeholder="Ej: Internet">`;
...
function crearFilaDeuda(n="", m="", e=false, p="") {
    ...
    f.insertCell(0).setAttribute("data-label", "Nombre");
    f.cells[0].innerHTML = `<input value="${n}" placeholder="Ej: Tarjeta">`;
    ...
    f.cells[3].innerHTML = `<input oninput='formatearNumero(this)' value="${p}" placeholder="Mínimo">`;
...
function irAResultados() {
    ...
    let datos = { sueldo: sueldo.value, tipoIngreso: document.getElementById("tipoIngreso").value, deudas: [], gastos: [] };
